...
/***/ function(module, exports, __webpack_require__) {
	...
	**/
	...
	EasyStar.js = function () {
	    ...
	    var pointsToAvoid = {};
	    var enablePointsToAvoid = false;
	    var collisionGrid;
	    var costMap = {};
	    var pointsToCost = {};
	    var enablePointsToCost = false;
	    var directionalConditions = {};
	    var enableDirectionalConditions = false;
	    var allowCornerCutting = true;
	    var iterationsSoFar;
	    var instances = [];
	    var iterationsPerCalculation = Number.MAX_VALUE;
	    var acceptableTiles;
	    var acceptableTileChecker;
	    ...
	    **/
	    ...
	    this.setAcceptableTileChecker = function (checker) {
	    	acceptableTileChecker = checker;
	    }
	    ...
	    **/
	    this.setDirectionalCondition = function (x, y, allowedDirections) {
	        ...
	        enableDirectionalConditions = true;
	    };
	    ...
	    **/
	    this.removeAllDirectionalConditions = function () {
	        ...
	        enableDirectionalConditions = false;
	    };
	    ...
	    **/
	    ...
	    var checkAdjacentNode = function (instance, searchNode, x, y, cost) {
	        ...
	        if ((!enablePointsToAvoid || pointsToAvoid[adjacentCoordinateX + "_" + adjacentCoordinateY] === undefined) && isTileWalkable(collisionGrid, acceptableTiles, adjacentCoordinateX, adjacentCoordinateY, searchNode)) {
	    ...
	    var isTileWalkable = function (collisionGrid, acceptableTiles, x, y, sourceNode) {
	        if (enableDirectionalConditions && directionalConditions[x + "_" + y]) {
	            var direction = calculateDirection(sourceNode.x - x, sourceNode.y - y);
	            var directionIncluded = function () {
	                for (var i = 0; i < directionalConditions[x + "_" + y].length; i++) {
	                    if (directionalConditions[x + "_" + y][i] === direction) {
							if (acceptableTileChecker) {
								return acceptableTileChecker(y, x)
							}
							return true;
						}
	                }
